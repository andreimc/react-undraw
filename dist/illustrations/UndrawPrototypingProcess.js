...
const UndrawPrototypingProcess = _props => {
  ...
  return React.createElement("svg", _extends({
    ...
    fill: primaryColor,
    opacity: 0.1,
    d: "M555.8 149.45h425.32v494.09H555.8z"
    ...
    d: "M768.46 131.76a8.55 8.55 0 1 1 8.55-8.55 8.57 8.57 0 0 1-8.55 8.55z",
    fill: "#fff"
  }), React.createElement("path", {
    d: "M768.46 115.16a8.05 8.05 0 1 1-8.05 8.05 8.06 8.06 0 0 1 8.05-8.05m0-1a9.05 9.05 0 1 0 9 9.05 9 9 0 0 0-9-9.05z",
    fill: "#fff"
  }), React.createElement("rect", {
    x: 575.56,
    y: 302.51,
    ...
    fill: "#504f60",
    d: "M411.9 602.25h15.91v5.98H411.9z"
  }), React.createElement("path", {
    opacity: 0.1,
    ...
    fill: "#fff",
    d: "M311.38 396.23h213.91v205.11H311.38z"
  }), React.createElement("rect", {
    x: 264.46,
    y: 396.23,
    width: 308,
    ...
    d: "M422.5 327.64v49.53h-8.34v-49.53a4.17 4.17 0 1 1 8.34 0z",
    fill: "#504f60"
  }), React.createElement("path", {
    opacity: 0.1,
    d: "M414.16 372.66h8.35v4.51h-8.35z"
  }), React.createElement("path", {
    d: "M425.78 376.04v16.36h-14.89v-16.36a2 2 0 0 1 2-2h10.83a2 2 0 0 1 2.06 2z",
    fill: "#504f60"
  }), React.createElement("circle", {
    cx: 418.33,
    cy: 384.39,
    ...
    fill: "#504f60",
    d: "M404.79 391.72h27.08v4.51h-27.08z"
  }), React.createElement("path", {
    d: "M364.63 596h111.58a6 6 0 0 1 6 6H358.65a6 6 0 0 1 5.98-6zM377.94 602.36l8.58-.22-.27 2.59h-8.56l.25-2.37zM411.9 602.25h15.91v2.48H411.9zM461.68 604.73h-8.56l-.26-2.59 8.57.22.25 2.37z",
    opacity: 0.1
  }), React.createElement("path", {
    d: "M364.63 597.4h111.58a6 6 0 0 1 6 6H358.65a6 6 0 0 1 6-6z",
    fill: "#504f60"
  }), React.createElement("path", {
    d: "M517.82 420.32a1.49 1.49 0 0 1 1.71 1.64c-1.45 14-.52 28.34 1.05 42.31.73 6.39 1.72 13.15 4.55 17.89a1.51 1.51 0 0 1-.2 1.86 4 4 0 0 1-2.78.83l-44.63.25a1.49 1.49 0 0 1-1.46-1.84c3.59-15.3 2.82-32 1.38-47.87-.71-7.81-1.12-12 4.71-12.55 6-.54 12-.79 18-1.29 1.44-.12 12.98-.46 17.67-1.23zM483.67 512.01a1.49 1.49 0 0 0-1.71 1.64c1.45 14 .52 28.34-1.06 42.31-.72 6.39-1.71 13.15-4.54 17.9a1.49 1.49 0 0 0 .2 1.85 4 4 0 0 0 2.78.83l44.63.26a1.51 1.51 0 0 0 1.46-1.85c-3.59-15.3-2.82-32-1.38-47.87.71-7.81 1.12-12-4.71-12.55s-12-.79-18-1.29c-1.44-.12-12.98-.46-17.67-1.23z",
    fill: "#fff",
    stroke: "#33313f",
    strokeMiterlimit: 10,
    strokeWidth: 3
  }), React.createElement("path", {
    d: "M496.78 537.77a132.37 132.37 0 0 1 15.56.19 1.47 1.47 0 0 1 1.32 1.3l.49 4.09a.58.58 0 0 1-.12.53.55.55 0 0 1-.38.1c-2.18.06-4.36-.19-6.53 0-1.35.11-2.69.37-4 .52a47.75 47.75 0 0 1-6.66.12 33.56 33.56 0 0 1-9.27-1.14s.18-3.39.18-3.71c0-1.58-.05-1.72 1.58-1.76zM496.78 556.21a130.24 130.24 0 0 0

    stroke: "#33313f",
    strokeLinecap: "round",
    strokeMiterlimit: 10,
    ...
    d: "M490.52 477.84a6.61 6.61 0 0 1 .43 3.48.51.51 0 0 1-.06.27.56.56 0 0 1-.42.15l-9.51.37s.54-2.8.61-3c.32-1.14 1.16-.84 2.23-.9z",
    fill: "#fff",
    stroke: "#33313f",
    strokeLinecap: "round",
    strokeMiterlimit: 10,
    ...
    d: "M285.79 845.45l-23.35 2.26-32.39-7.54-9.82-9.79.8-2.39 1.12-3.36 1.1-3.29 21.84-6a13.5 13.5 0 0 0 4.43 4.43c7.09 4.85 19.84 8.36 27.32 10.11.31.08.63.17.93.28a9.92 9.92 0 0 1 6.49 7z",
    fill: "#db8b8b"
  }), React.createElement("path", {
    d: "M285.79 845.45l-23.35 2.26-32.39-7.54-9.82-9.79.8-2.39 9 6.91s16.58 9 24.86 7.53h23.34l-4.52-6 4.06-6.27a9.92 9.92 0 0 1 6.49 7z",
    opacity: 0.1
  }), React.createElement("path", {
    ...
    d: "M259.43 406.32s-36.15 3.76-30.88-11.3a27 27 0 0 0 1.11-13.3 36.91 36.91 0 0 0-6.38-15.32l33.89 5.27a42.32 42.32 0 0 0-4.59 10.88c-4.04 15.99 6.85 23.77 6.85 23.77z",
    fill: "#db8b8b"
  }), React.createElement("path", {
    ...
    d: "M182.6 474.11l-4.52 12.05-3.76 25.61a22.65 22.65 0 0 0 6.78 19.58c9 9 21.09 27.87 21.09 27.87l14.31-42.93s-14.31-2.26-12-12.05 1.5-27.87 1.5-27.87z",
    fill: primaryColor
  }), React.createElement("path", {
    d: "M249.55 819.75c-9.67 15.21-24.7 6.59-27.37 4.88l1.1-3.29 21.84-6a13.5 13.5 0 0 0 4.43 4.41z",
    opacity: 0.1
  }), React.createElement("path", {
    d: "M279.77 607.43c-.76 10.54-13.56 49-13.56 49l-9 31.61a251.29 251.29 0 0 0-9.98 68.72c0 7.71-.71 15.67-2.88 21.65-6 16.57 6 39.17 6 39.17-10.54 18.83-28.62 6-28.62 6v-12s-14.27-65.56-10.5-78.36 5.28-47.46 5.28-47.46v-62.51a70.9 70.9 0 0 1-20.67-45c-.18-2.47-.33-5.06-.42-7.75-.61-17 11-36.92 15.54-44 1.1-1.72 1.78-2.68 1.78-2.68l66.49 26.38.15.06v8.27z",
    fill: "#35323e"
  }), React.createElement("path", {
    d: "M257.17 371.67a42.32 42.32 0 0 0-4.59 10.88 29.42 29.42 0 0 1-22.92-.83 36.91 36.91 0 0 0-6.38-15.32z",
    opacity: 0.1
  }), React.createElement("circle", {
    cx: 242.11,
    cy: 353.59,
    ...
    d: "M279.77 558.47l-.33.06c-31.58 6.49-71.21-26.42-71.21-26.42a38 38 0 0 0 2.74-5.61c1.1-1.72 1.78-2.68 1.78-2.68l66.48 26.38.17 2.63z",
    opacity: 0.1
  }), React.createElement("path", {
    ...
    d: "M273.74 559.22s15.82 3 23.35 15.07a46.86 46.86 0 0 0 7.89 9.85 6 6 0 0 1-.94 9.52c-6 3.6-15.72 5.81-28-4.31-21.13-17.32-2.3-30.13-2.3-30.13z",
    fill: "#db8b8b"
  }), React.createElement("path", {
...
UndrawPrototypingProcess.propTypes = {
  height: PropTypes.string,
  primaryColor: PropTypes.string
};
export default UndrawPrototypingProcess;