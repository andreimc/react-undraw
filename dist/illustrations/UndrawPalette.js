...
var UndrawPalette = function UndrawPalette(_props) {
  ...
  return _react.default.createElement("svg", _extends({
    ...
    d: "M572.892 641.149s-5.036-13.776-26.366 0c0 0-8.444 12.442-3.703 16.294s12.887 9.035 19.7 6.073 9.48-6.221 10.37-12.295a30.523 30.523 0 0 0 0-10.072z",
    fill: "#2f2e41"
  }), _react.default.createElement("path", {
    ...
    d: "M649.918 641.149s5.037-13.776 26.367 0c0 0 8.443 12.442 3.703 16.294s-12.887 9.035-19.7 6.073-9.48-6.221-10.37-12.295a30.523 30.523 0 0 1 0-10.072z",
    fill: "#2f2e41"
  }), _react.default.createElement("path", {
    ...
    d: "M1053.401 556.878c0 59.806-35.548 80.68-79.41 80.68-1.014 0-2.028-.01-3.03-.031a112.253 112.253 0 0 1-6.041-.289c-39.583-2.785-70.329-24.737-70.329-80.36 0-57.575 73.616-130.251 79.08-135.566l.01-.01c.203-.204.31-.3.31-.3s79.41 76.081 79.41 135.876z",
    fill: primaryColor
  }), _react.default.createElement("path", {
    ...
    d: "M227.401 637.628c0 28.926-17.193 39.022-38.407 39.022-.49 0-.98-.005-1.466-.015a54.293 54.293 0 0 1-2.922-.14c-19.144-1.347-34.015-11.964-34.015-38.867 0-27.846 35.605-62.997 38.248-65.568l.005-.005c.098-.098.15-.144.15-.144s38.407 36.797 38.407 65.717z",
    fill: primaryColor
  }), _react.default.createElement("path", {
    d: "M187.595 672.227l14.05-19.625-14.08 21.777-.037 2.256a54.293 54.293 0 0 1-2.922-.14l1.513-28.93-.01-.228.025-.04.145-2.731-14.117-21.834 14.158 19.785.036.578 1.14-21.865-12.082-22.561 12.233 18.72 1.192-45.329.005-.15v.145l-.201 35.75 12.032-14.169-12.084 17.25-.315 19.573 11.232-18.783-11.278 21.663-.176 10.886 16.306-26.149-16.368 29.943z",
    fill: "#3f3d56"
  }), _react.default.createElement("path", {
    d: "M894.401 656.628c0 28.926-17.193 39.022-38.407 39.022-.49 0-.98-.005-1.466-.015a54.293 54.293 0 0 1-2.922-.14c-19.144-1.347-34.015-11.964-34.015-38.867 0-27.846 35.605-62.997 38.248-65.568l.005-.005c.098-.098.15-.144.15-.144s38.407 36.797 38.407 65.717z",
    fill: primaryColor
  }), _react.default.createElement("path", {
    d: "M854.595 691.227l14.05-19.625-14.08 21.777-.037 2.256a54.293 54.293 0 0 1-2.922-.14l1.513-28.93-.01-.228.025-.04.145-2.731-14.117-21.834 14.158 19.785.036.578 1.14-21.865-12.082-22.561 12.233 18.72 1.192-45.329.005-.15v.145l-.201 35.75 12.032-14.169-12.084 17.25-.315 19.573 11.232-18.783-11.278 21.663-.176 10.886 16.306-26.149-16.368 29.943z",
    fill: "#3f3d56"
  }));
};

UndrawPalette.propTypes = {
  height: _propTypes.default.string,
  primaryColor: _propTypes.default.string
};
var _default = UndrawPalette;
