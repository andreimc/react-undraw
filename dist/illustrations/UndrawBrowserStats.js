...
const UndrawBrowserStats = _props => {
  ...
  return React.createElement("svg", _extends({
    ...
    fill: "#f5f5f5",
    d: "M51.48 242.277L674.936 38.833l8.274 25.355L59.754 267.632z"
  }), React.createElement("path", {
    fill: "#fff",
    d: "M59.835 267.47l624.08-203.017 127.64 392.371-624.08 203.016z"
  }), React.createElement("path", {
    d: "M77.42 247.63a7.62 7.62 0 1 1-9.61-4.89 7.63 7.63 0 0 1 9.61 4.89z",
    fill: "#ff5252"
  }), React.createElement("path", {
    d: "M97.7 241.01a7.62 7.62 0 1 1-9.61-4.89 7.63 7.63 0 0 1 9.61 4.89z",
    fill: "#ff0"
  }), React.createElement("path", {
    d: "M117.99 234.38a7.62 7.62 0 1 1-9.61-4.89 7.63 7.63 0 0 1 9.61 4.89z",
    fill: "#69f0ae"
  }), React.createElement("path", {
    transform: "rotate(-18.07 -51.935 796.181)",
    fill: "url(#prefix__b)",
    d: "M232.73 367.44H443.1v18.3H232.73z"
  }), React.createElement("path", {
    fill: primaryColor,
    d: "M86.665 300.775l198.55-64.78 4.73 14.498-198.55 64.78zM482.315 171.684l198.549-64.78 4.73 14.497-198.55 64.781z"
  }), React.createElement("path", {
    opacity: 0.2,
    d: "M482.315 171.684l198.549-64.78 4.73 14.497-198.55 64.781z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.2,
    d: "M118.279 397.965l8.698-2.838 2.838 8.698-8.698 2.838z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.5,
    d: "M708.127 205.515l8.699-2.838 2.838 8.698-8.699 2.839z"
  }), React.createElement("path", {
    ...
    fill: primaryColor,
    opacity: 0.8,
    d: "M213.79 455.052l89.849-29.315 2.838 8.698-89.849 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.7,
    d: "M336.975 414.854l89.849-29.315 2.838 8.698-89.849 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.5,
    d: "M460.164 374.668l89.848-29.315 2.838 8.699-89.848 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.2,
    d: "M583.358 334.47l89.849-29.315 2.838 8.698-89.848 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.8,
    d: "M239.736 534.838l89.849-29.315 2.838 8.698-89.849 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.7,
    d: "M362.921 494.64l89.849-29.315 2.838 8.698-89.849 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.5,
    d: "M486.11 454.454l89.848-29.315 2.838 8.699-89.848 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.2,
    ...
    fill: "#64ffda",
    d: "M434.217 294.882l89.849-29.315 2.838 8.699-89.849 29.315z"
  }), React.createElement("path", {
    fill: primaryColor,
    opacity: 0.2,
    d: "M557.403 254.697l89.848-29.315 2.838 8.699-89.848 29.315z"
  }), React.createElement("path", {
    transform: "rotate(-18.07 -74.544 995.34)",
    fill: "url(#prefix__c)",
    d: "M291.69 552.06h47.26v47.29h-47.26z"
  }), React.createElement("path", {
    transform: "rotate(-18.07 -48.577 1075.135)",
    fill: "url(#prefix__d)",
    d: "M317.64 631.84h47.26v47.29h-47.26z"
  }), React.createElement("path", {
    fill: primaryColor,
    ...
    fill: primaryColor,
    opacity: 0.1,
    d: "M71.186 280.702l246.192-80.337 1.891 5.795-246.192 80.337z"
  }), React.createElement("path", {
    ...
    fill: primaryColor,
    opacity: 0.1,
    d: "M712.057 254.784l7.244-2.363 49.207 150.815-7.244 2.364z"
  }));
};
