...
var UndrawOnlinePage = function UndrawOnlinePage(_props) {
  ...
  return _react.default.createElement("svg", _extends({
    ...
    fill: "#3f3d56",
    d: "M143.353 160.003h822v444h-822z"
  }), _react.default.createElement("path", {
    fill: "#3f3d56",
    d: "M143.353 124.003h822v41h-822z"
    ...
    opacity: 0.1,
    d: "M143.353 160.003h822v5h-822z"
  }), _react.default.createElement("path", {
    fill: primaryColor,
    opacity: 0.3,
    d: "M190.853 230.503h162v173h-162z"
  }), _react.default.createElement("path", {
    fill: primaryColor,
    d: "M201.853 218.503h162v173h-162z"
  }), _react.default.createElement("path", {
    fill: primaryColor,
    opacity: 0.3,
    ...
    fill: primaryColor,
    d: "M793.309 218.503h124.543v133H793.309z"
  }), _react.default.createElement("path", {
    fill: primaryColor,
    opacity: 0.3,
    ...
    d: "M112.427 650.56s0 12.647-1.264 15.176-3.795 15.177 3.794 15.177a30.69 30.69 0 0 0 12.647-2.53s0-7.588 3.794-8.853 12.647-11.382 8.853-13.912-11.382-5.058-11.382-5.058zM166.81 656.883s-7.588 17.706 0 18.97 17.706 0 18.97-2.529 3.795-5.059 6.324-3.794 24.03-13.912 16.441-16.441a21.897 21.897 0 0 0-13.911 0l-7.589-3.794zM129.057 315.08a2.598 2.598 0 0 0 1.03-.285 2.66 2.66 0 0 0 .958-1.66l2.583-9.15c.98-3.473 2.554-7.528 6.087-8.263a5.74 5.74 0 0 0 2.131-.567 3.69 3.69 0 0 0 1.158-2.854l1.106-11.828c.3-3.198.584-6.523-.532-9.535-1.645-4.442-6.157-7.367-10.819-8.208s-9.465.1-14.003 1.459c-6.885 2.062-14.014 5.613-17.004 12.147-1.732 3.783-1.839 8.097-1.607 12.251.238 4.278.833 8.638 2.8 12.444a37.301 37.301 0 0 0 3.79 5.572c2.135 2.763 4.754 8.166 8.287 9.197 3.983 1.162 9.999-.196 14.035-.72zM830.105 583.573c0 38.029 23.858 68.801 53.34 68.801",
    fill: "#2f2e41"
  }), _react.default.createElement("path", {
...
UndrawOnlinePage.propTypes = {
  height: _propTypes.default.string,
  primaryColor: _propTypes.default.string
};
var _default = UndrawOnlinePage;
