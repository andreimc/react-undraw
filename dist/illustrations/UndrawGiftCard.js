...
const UndrawGiftCard = _props => {
  ...
  return React.createElement("svg", _extends({
    ...
    d: "M609.69 308.5H487.424a4.866 4.866 0 0 0-4.866 4.866v16.268a4.866 4.866 0 0 0 4.866 4.866h6.634v82.634a4.866 4.866 0 0 0 4.866 4.866h92.268a4.866 4.866 0 0 0 4.866-4.866V334.5h13.634a4.866 4.866 0 0 0 4.866-4.866v-16.268a4.866 4.866 0 0 0-4.866-4.866z",
    fill: "#f2f2f2"
  }), React.createElement("path", {
    d: "M504.057 329.5h102v79.055a9.445 9.445 0 0 1-9.445 9.445h-83.11a9.445 9.445 0 0 1-9.445-9.445V329.5h0z",
    fill: "none",
    stroke: "#3f3d56",
    strokeMiterlimit: 10
  }), React.createElement("rect", {
    ...
    fill: primaryColor,
    d: "M537.057 307h24.5v111h-24.5z"
  }), React.createElement("path", {
    fill: "none",
    stroke: "#3f3d56",
    strokeMiterlimit: 10,
    ...
    d: "M197.435 171.855s-48.908 54.567-64.268 40.824-29.506-46.483-18.189-56.992c6.112-5.675 6.564-16.532 5.691-25.328a85.236 85.236 0 0 0-2.457-13.476s24.252-7.275 25.06 7.276a11.086 11.086 0 0 0 1.318 4.89c4.632 8.222 19.7 4.002 19.7 4.002z",
    fill: "#fbbebe"
  }), React.createElement("path", {
    d: "M161.057 135.477l3.234-2.426a96.752 96.752 0 0 1 37.995 5.66c19.401 7.275 53.354 13.742 63.055 11.317s33.145-7.276 33.145-7.276 25.869-10.509 31.528 2.425-34.762 12.935-34.762 12.935-28.698 11.722-48.908 10.105-46.483 7.68-58.61-2.021-26.677-30.72-26.677-30.72zM64.857 444.287H43.03l-8.084 16.168 10.51 11.317s20.21-2.425 25.868-8.892-6.467-18.593-6.467-18.593z",
    fill: "#fbbebe"
  }), React.createElement("path", {
    ...
    d: "M144.59 129.05a29.975 29.975 0 0 1-23.92 1.31 85.236 85.236 0 0 0-2.458-13.477s24.252-7.275 25.06 7.276a11.086 11.086 0 0 0 1.318 4.89z",
    opacity: 0.1
    ...
    d: "M758.777 165.434a20.813 20.813 0 1 0 2.772-39.915l.52 10.712-5.068-9.18a20.734 20.734 0 0 0-10.683 11.722 20.409 20.409 0 0 0-1.197 5.63 20.809 20.809 0 0 0 13.656 21.031z",
    fill: "#57b894"
  }), React.createElement("path", {
    d: "M783.854 289.678c-1.789-9.11 5.964-17.187 13.621-22.437s16.605-10.408 19.218-19.317c3.755-12.804-7.43-24.53-16.136-34.642a125.3 125.3 0 0 1-16.523-24.557c-1.811-3.532-3.476-7.225-3.952-11.166-.687-5.676 1.137-11.323 2.973-16.737q9.18-27.052 19.629-53.65",
    fill: "none",
    stroke: "#3f3d56",
    strokeMiterlimit: 10
  }), React.createElement("path", {
    d: "M759.634 162.676a20.813 20.813 0 1 0 2.772-39.915l.52 10.712-5.067-9.18a20.734 20.734 0 0 0-10.684 11.722 20.408 20.408 0 0 0-1.197 5.63 20.809 20.809 0 0 0 13.656 21.031z",
    fill: "none",
    stroke: "#3f3d56",
    strokeMiterlimit: 10
  }), React.createElement("path", {
    d: "M781.31 103.473a20.788 20.788 0 0 1 14.98-13.198l1.714 10.184 3.177-10.696a20.81 20.81 0 1 1-19.87 13.71z",
    fill: "#57b894"
  }), React.createElement("path", {
    d: "M782.453 99.795a20.788 20.788 0 0 1 14.98-13.197l1.714 10.184 3.177-10.696a20.81 20.81 0 1 1-19.87 13.71z",
    fill: "none",
    stroke: "#3f3d56",
    strokeMiterlimit: 10
  }), React.createElement("path", {
    d: "M796.904 213.489a20.81 20.81 0 0 0 18.419-37.023l-2.441 8.22-1.731-10.304a.362.362 0 0 0-.053-.02 20.811 20.811 0 1 0-14.194 39.127z",
    fill: "#57b894"
  }), React.createElement("path", {
    d: "M797.894 209.764a20.81 20.81 0 0 0 18.42-37.023l-2.442 8.22-1.731-10.304a.362.362 0 0 0-.053-.02 20.811 20.811 0 1 0-14.194 39.127z",
    fill: "none",
    stroke: "#3f3d56",
    strokeMiterlimit: 10
  }), React.createElement("path", {
    d: "M775.237 248.051a20.801 20.801 0 1 0 4.01-16.297l9.273 13.957-12.67-7.408a20.617 20.617 0 0 0-.613 9.748z",
    fill: "#57b894"
  }), React.createElement("path", {
    d: "M776.094 245.294a20.801 20.801 0 1 0 4.01-16.298l9.273 13.957-12.67-7.408a20.616 20.616 0 0 0-.613 9.749z",
    fill: "none",
    stroke: "#3f3d56",
    strokeMiterlimit: 10
  }));
...
UndrawGiftCard.propTypes = {
  height: PropTypes.string,
  primaryColor: PropTypes.string
};
export default UndrawGiftCard;